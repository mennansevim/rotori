    ...
    for folder, base_status in folders:
        ...
        for jpg in folder.glob("*.jpg"):
            ...
            items.append({
                ...
                "content_category": meta.get("content_category") or "",
                "content_category_label": meta.get("content_category_label") or "",
                "editorial_category": meta.get("kategori") or "",
                "score": meta.get("toplam_puan"),
